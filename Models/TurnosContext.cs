...
namespace Turnos.Models
{
    public class TurnosContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Medico>(entidad =>
                {
                    ...
                    entidad.HasKey(modelBuilder => modelBuilder.IdMedico);
            ...
            /* Aqui definimos una restriccion entre la tabla Medico, y la tabla MedicoEspecialidad
           Con la propiedad HasOne y la propiedad WithMany estamos estableciendo una relacion de 1 a muchos,
           es decir, un Medico puede tener muchas Especialidades, y con la propiedad HasForeignKey lo que
           hacemos es decir cual va a ser el campo que va a ser clave foranea, en este caso sera
           IdMedico de la tabla MedicoEspecialidad  */
            ...
            modelBuilder.Entity<Turno>(entidad =>
                    {
                        ...
                        entidad.HasKey(modelBuilder => modelBuilder.IdTurno);

                        entidad.Property(m => m.IdTurno)
                        .IsRequired()
                        .IsUnicode(false);
