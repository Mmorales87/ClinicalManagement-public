...
namespace Turnos.Controllers
{
    public class MedicoController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            /* Include viene siendo un inner join que cruza la tabla medico con los registro de la entidad
            MedicoEspecialidad.
            El metodo FirstOrDefaultAsync obtiene el primer parametro que cumpla la condicion, en este caso
            sera el campo IdMedico sera igual al campo id de MedicoEspecialidad */
