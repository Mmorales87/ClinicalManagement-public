...
namespace Turnos.Controllers
{
    public class EspecialidadController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id) /* el '?' es en caso de que reciba un parametro con valor null 
                                            no obtendremos una excepcion, y nos dejara acceder al metodo*/
        {
            if (id == null)
            {
